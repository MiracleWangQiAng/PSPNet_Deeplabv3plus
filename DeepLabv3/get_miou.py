...
if __name__ == "__main__":
    ...
    #   默认指向根目录下的VOC数据集
    #-------------------------------------------------------#
    VOCdevkit_path  = 'D:\pycharm\py37torch120\VOCdevkit'

    valpath = os.path.join(VOCdevkit_path, 'VOC2007/ImageSets/Segmentation/val.txt')
    valpath = valpath.replace('\\', '/')
    image_ids       = open(valpath, 'r').read().splitlines()
